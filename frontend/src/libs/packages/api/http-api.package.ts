import { type ContentType, ServerErrorType } from "@/enums/enums.js";
...
import { type IStorage, StorageKey } from "@/packages/storage/storage.js";
import { type ServerErrorResponse, type ValueOf } from "@/types/types.js";
...
class HttpApi implements IHttpApi {
  ...
  public async load(
    ...
    const response = await this.http.load(path, { method, headers, payload });
